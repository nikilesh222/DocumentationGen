...
export class AuthorizeService {
  ...
  public getUser(): Observable<IUser | null> {
    if (this.userSubject)
      ...
      return concat(this.getUserFromStorage().pipe(filter(u => !!u), tap(u => this.userSubject ? this.userSubject.next(u) : null)));
  }
  ...
  public isAccessTokenAvail(): Observable<boolean> {
    return from(this.ensureUserManagerInitialized())
      .pipe(mergeMap(() => from(this.userManager.getUser())),
        map(user => user != null && user.access_token != null));
  }
